...
exec sudo -u vagrant /bin/bash -l << eof
	...
	unzip -n /vagrant/scripts/crs_artifacts/server-ATGProduction.zip -d /home/vagrant/ATG/ATG11.1/home/servers
	unzip -n /vagrant/scripts/crs_artifacts/server-ATGPublishing.zip -d /home/vagrant/ATG/ATG11.1/home/servers

	# copy ATG version file store
	unzip -n /vagrant/scripts/crs_artifacts/versionFileStore.zip -d /home/vagrant/ATG/ATG11.1/home/Publishing
	...
	/usr/local/endeca/ToolsAndFrameworks/11.1.0/deployment_template/bin/deploy.sh --app /home/vagrant/deploy/deploy.xml < /vagrant/scripts/deploy_CRS_endeca_silent.silentinput
