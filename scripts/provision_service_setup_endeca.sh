...
cp /vagrant/scripts/endeca/endecaplatform /etc/init.d/endecaplatform
chmod 750 /etc/init.d/endecaplatform
chkconfig --add endecaplatform

cp /vagrant/scripts/endeca/endecaworkbench /etc/init.d/endecaworkbench
chmod 750 /etc/init.d/endecaworkbench
chkconfig --add endecaworkbench

cp /vagrant/scripts/endeca/endecacas /etc/init.d/endecacas
chmod 750 /etc/init.d/endecacas
chkconfig --add endecacas

# start all services
/vagrant/scripts/start_endeca_services.sh
